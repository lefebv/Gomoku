=======================================================================
    APPLICATION WIN32 : Vue d'ensemble du projet Gomoku
========================================================================
...
Gomoku.ico
    Il s'agit d'un fichier icône, qui est utilisé comme icône de l'application (32x32). Cette icône est incluse par le fichier de ressources principal Gomoku.rc.

small.ico
    Il s'agit d'un fichier icône qui contient une version plus petite (16x16) de l'icône de l'application. Cette icône est incluse par le fichier de ressources principal Gomoku.rc.
